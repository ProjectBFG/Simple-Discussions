...
QuickModifyTopic.prototype.modify_topic_show_edit = function (subject)
{
	...
	setInnerHTML(this.oCurSubjectDiv, '<input type="text" name="subject" value="' + subject + '" maxlength="80" class="form-control" /><input type="hidden" name="topic" value="' + this.iCurTopicId + '" /><input type="hidden" name="msg" value="' + this.sCurMessageId.substr(4) + '" />');
