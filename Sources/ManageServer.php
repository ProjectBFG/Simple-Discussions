 ...
 *  - PLUS you can override label by forcing their keys in the array, for example:
...
function ModifyGeneralSettings($return_config = false)
{
	...
	For each option:
		variable name, description, type (constant), size/possible values.
	...
	$config_vars = array(
		...
		'',
		array('enableCompressedOutput', $txt['enableCompressedOutput'], 'db', 'check', null),
		array('disableTemplateEval', $txt['disableTemplateEval'], 'db', 'check', null),
		array('disableHostnameLookup', $txt['disableHostnameLookup'], 'db', 'check', null),
	);
...
function ModifyDatabaseSettings($return_config = false)
{
	...
	$config_vars = array(
		...
		array('db_persist', $txt['db_persist'], 'file', 'check', null),
		array('db_error_send', $txt['db_error_send'], 'file', 'check'),
		array('ssi_db_user', $txt['ssi_db_user'], 'file', 'text', null),
